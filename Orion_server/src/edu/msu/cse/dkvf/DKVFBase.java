...
public abstract class DKVFBase {
     ...
     * @param value The value to insert for the record.
     * @return The result of the operation.
     */
     ...
     * @param p      The predicate to check for the value.
     * @param result The value of the record. . Only the first element of the list
