...
public abstract class Storage {
     ...
     *
     * @param parameters A map of properties required by the storage engine to initialized.
     * @param logger     The logger used by the storage engine.
     ...
     *
     * @param key   The record key of the key to insert.
     * @param value The value to insert to the record.
     * @return The result of the operation.
     */
     ...
     *
     * @param key    The record key of the key to read.
     * @param p      The predicate that must be true for the value to be returned.
     * @param result The value of the record. . Only the first element of the list will be used as the result value.
